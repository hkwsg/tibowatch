...
These instructions describe the RSS-based v1.1.2 release. The deployment guide checks the selected code version before installing.
...
```text
Please deploy v1.1.2 of https://github.com/hkwsg/tibowatch on my authorized Linux server.
...
Pinned release entry: [v1.1.2 deployment prompt](https://github.com/hkwsg/tibowatch/blob/v1.1.2/DEPLOY_WITH_CODEX.md).
